...
const contactDetails = [
  ...
  {
    value: 'Sahabiye Mh.,Kalenderhane Sk.,Yücel Apt.,A Blok Kat:1 No:2 38010 Kocasinan/Kayseri',
    icon: locationIcon,
  },
  { value: '+90 507 172 3052', icon: phoneIcon },
  { value: 'avbanukok@gmail.com', icon: emailIcon },
]
...
const Info = () => (
  <section className="info">
    <h2 className="info-h2">İletişim Bilgileri</h2>
